...
public class Exercicio2 {
    public static void main(String[] args) throws Exception {
        ...
        Job j = new Job(c, "transactionsPerYear");

        // 1 - Registro das classes (definir quem é a classe principal, quem é o map, quem é o reduce)
        j.setJarByClass(Exercicio2.class); // main
        j.setMapperClass(Exercicio2.Map.class); // map
        j.setReducerClass(Exercicio2.Reduce.class); // class
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context con) throws IOException, InterruptedException {
            ...
            // obtendo o ano da linha
            String ano = linha.split(";")[1];

            Text chaveSaida = new Text(ano);
